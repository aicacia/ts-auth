...
export interface ApplicationApiInterface {
     ...
     * @memberof ApplicationApiInterface
     */
    indexRaw(requestParameters: IndexRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginationApplication>>;

    /**
     */
    index(page?: number | null, pageSize?: number | null, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginationApplication>;
    ...
    /**
     */
    resetSecret(applicationId: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApplicationWithSecret>;
...
export class ApplicationApi extends runtime.BaseAPI implements ApplicationApiInterface {
    ...
    /**
     */
    async indexRaw(requestParameters: IndexRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginationApplication>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async index(page?: number | null, pageSize?: number | null, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginationApplication> {
    ...
    /**
     */
    async resetSecret(applicationId: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApplicationWithSecret> {
